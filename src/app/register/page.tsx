        ...
        <form className="my-8" onSubmit={handleSubmit}>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            <LabelInputContainer>
              ...
              <Input id="nama" placeholder="Masukkan Nama Anda" type="text" value={formData.nama} onChange={handleChange} />
            </LabelInputContainer>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            >
              <FaCheck className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
